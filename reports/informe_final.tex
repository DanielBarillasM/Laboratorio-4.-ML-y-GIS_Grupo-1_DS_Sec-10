...
\begin{table}[H]
\centering
% ATENCION: cifras pendientes de regenerar con scripts/run_ml_final.py tras el
% cambio a mapas fuera de muestra (antes se usaba el reajuste con las 220,000 filas).
...
Los mapas son coherentes con la Parte 1: la escena final de Atitlán presenta concentración baja casi generalizada, mientras que Amatitlán mantiene un patrón amplio de riesgo alto. La comparación no es una validación independiente, porque la clase observada proviene del mismo proxy remoto y se calcula sobre el mismo píxel que alimenta al modelo; su utilidad es verificar concordancia espacial y priorizar puntos de muestreo. El mapa de Amatitlán debe leerse junto con la fila temporal del cuadro de escenarios: sobre esa misma escena el Gradient Boosting alcanza recall 0.5611 y F1 0.6651, muy por debajo de su desempeño aleatorio, de modo que la concordancia visual global convive con una omisión apreciable de píxeles altos.
